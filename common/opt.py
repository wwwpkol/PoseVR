...
class opts():
    ...
    def init(self):
        ...
        self.parser.add_argument('--lr_decay_large', type=float, default=0.8)
        ...
        self.parser.add_argument('--n_heads', default=8, type=int)

        #eva
        self.parser.add_argument('--channels', type=int, default=512)
        ...
        #rnn
        self.parser.add_argument('--rnn_ndid', default=256, type=int)
        self.parser.add_argument('--rnn_dropout', default=0.0, type=float)
        self.parser.add_argument('--rnn_state', default=None, type=None)
        self.parser.add_argument('--frame', default=27, type=int)
        self.parser.add_argument('--IF_pose_state', default=True, type=bool)
        self.parser.add_argument('--noise_input_hist', type=float, default=0.1, help='')
        self.parser.add_argument('--rnn_dropout_r', default=0.2, type=float)

        # conv
        self.parser.add_argument('--conv_channel', default=512, type=int)
        self.parser.add_argument('--seed', default=1008, type=int)
